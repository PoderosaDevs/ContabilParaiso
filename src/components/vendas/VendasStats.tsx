import { FileSpreadsheet, CheckCircle2, Wallet, Percent } from "lucide-react";
...
export const VendasStats = ({ count, totalLiquido, totalRecebido, totalTaxas }: VendasStatsProps) => {
  return (
